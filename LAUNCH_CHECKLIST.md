...
> **生成时间**：2026-04-20
> **审计来源**：`backend/` 源码 + `backend/README.md` + PR #16–#45 合并记录 + `.github/workflows/test.yml`
...
- [ ] **短信服务商接入**（阿里云 SMS / 腾讯云 SMS）— 签名申请须营业执照 ｜ 依赖营业执照（mock 模式可用）
...
- [x] **API 文档** — `docs/API.md` 从源码读取的全量接口列表 ｜ 已完成（本次新增）
