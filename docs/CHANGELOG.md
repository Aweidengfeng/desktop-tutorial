...
>
> 项目后续已改用 [Semantic Versioning](https://semver.org/lang/zh-CN/) 并遵循 [Keep a Changelog](https://keepachangelog.com/zh-CN/1.1.0/) 规范，请前往仓库根目录的 **[CHANGELOG.md](../CHANGELOG.md)** 查看 v1.0.0 起的最新变更记录。
